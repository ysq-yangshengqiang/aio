          ...
          <div class="text-center">
            <div class="relative w-24 h-24 mx-auto">
              <svg class="w-24 h-24 transform -rotate-90" viewBox="0 0 36 36">
                <path class="text-gray-300" d="M18 2.0845 A 15.9155 15.9155 0 0 1 18 33.9155 A 15.9155 15.9155 0 0 1 18 2.0845 Z" stroke="currentColor" stroke-width="2" fill="none"/>
